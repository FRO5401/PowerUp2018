...
public class AutoPIDDrive extends Command {
	...
	protected boolean isFinished() {
        ...
        if ((Math.abs(Robot.drivebase.getSetpoint(1) - Robot.drivebase.getEncoderDistance("left")) < RobotMap.DRIVE_PID_ABSOLUTE_TOLERANCE) 	&&	(Math.abs(Robot.drivebase.getSetpoint(2) - Robot.drivebase.getEncoderDistance("right")) < RobotMap.DRIVE_PID_ABSOLUTE_TOLERANCE)) {
        	return true;
        } else {
        	return false;
        }
